...
$DB_Server = "beexmaster.db.4637596.hostedresource.com"; //your MySQL Server
$DB_Username = "beexmaster"; //your MySQL User Name
$DB_Password = "Bulld0zer"; //your MySQL Password
$DB_DBName = "beexmaster"; //your MySQL Database Name
