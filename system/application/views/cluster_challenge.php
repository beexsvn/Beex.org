...
<div id="LeftColumn">
    ...
    <div class="MiniProfile" id="BenefittingNPO">
        <h2><?php echo $item->cluster_npo; ?></h2>
        <p>This NPO helps others</p>
    </div>
</div>
...
<div id="RightColumn">
	<div id="challengeInfo">
        ...
        <div id="InfoDisplay" class="InfoDisplay">
            <h2><?php echo ($item->cluster_ch_title) ? $item->cluster_ch_title : $item->cluster_title; ?></h2>
            ...
            <div class="media">
                ...
                <div class="donation">
                	...
                	<div class="fundinfo">
	                    ...
	                    <p>Amount Raised: $0 of $<?php echo ($item->cluster_ch_goal) ? $item->cluster_ch_goal : $item->cluster_goal; ?> / Days Left: <?php echo process_days_left($item->cluster_ch_completion); ?></p>
                    </div>
                </div>
            </div>
            
            <div class="declaration">
                <p><span class='hl'>I</span> will <span class='hl'><?php echo ($item->cluster_ch_declaration) ? $item->cluster_ch_declaration : $item->cluster_declaration; ?></span> if<br /><span class='hlb'>$<?php echo ($item->cluster_ch_goal) ? $item->cluster_ch_goal : $item->cluster_goal; ?></span>
                <br />is raised for <br />
                <span class='hlb'><?php echo $item->cluster_npo; ?></span>
            ...
            <div class="essential">
           		<table class="whatwherewhen" cellspacing=0 cellpadding=0 border=0>
                    <tr>
                     <th>What:</th><td><?php echo ($item->cluster_ch_declaration) ? $item->cluster_ch_declaration : $item->cluster_declaration; ?></td>
					</tr>
                    <tr>
               ...
               <td style="width:184px; padding-left:16px;">
                <img src="/beex/images/challenge/prooftop.png" />
               	<div id="Proof">
                    ...
                    <p><span class='big'><?php echo process_days_left($item->cluster_ch_completion); ?></span> days</p>
